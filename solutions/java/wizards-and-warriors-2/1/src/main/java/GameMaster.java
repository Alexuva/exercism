public class GameMaster {
    ...
    public String describe(Character character, Destination destination, TravelMethod travelMethod) {
        return String.format("%s %s %s", this.describe(character), this.describe(travelMethod), this.describe(destination));
    };

    public String describe(Character character, Destination destination) {
        return String.format("%s %s %s", this.describe(character), this.describe(TravelMethod.WALKING), this.describe(destination));
    }
}
